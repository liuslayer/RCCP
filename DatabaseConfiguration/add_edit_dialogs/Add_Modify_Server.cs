...
namespace DatabaseConfiguration.add_edit_dialogs
{
    public partial class Add_Modify_Server : Form
    {
        ...
        private void ServerData(ServerList _tmpData)
        {
        ...
        private void btnsure_Click(object sender, EventArgs e)
        {
            ...
            if (txtname.Text.Trim() == "") { MessageBox.Show("请填写服务器名称！"); return; }
            else if (txtname.Text.Trim().ToString().Length > 25) { MessageBox.Show("服务器名称超过25个字符！"); return; }
            ...
            else { _ServerList.StationID = null; }
