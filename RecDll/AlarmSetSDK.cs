...
namespace AccessOperation
{
    ...
    {
        public static Alarm_Command.ArmAndDisarmList_Command Alarm_Command=new DeviceBaseData.Alarm_Command.ArmAndDisarmList_Command();
        public static Camera_Command CameraList_Command = new Camera_Command();
        public static StreamMedia_Command StreamMediaList_Command = new StreamMedia_Command();
        private static List<ArmAndDisarmList> armAndDisarmList = new List<ArmAndDisarmList>();
        private static List<DatabaseConfiguration.DeviceEntitiy.CameraList> cameraList = new List<DatabaseConfiguration.DeviceEntitiy.CameraList>();
        private static List<DatabaseConfiguration.DeviceEntitiy.StreamMediaList> streamMediaList = new List<DatabaseConfiguration.DeviceEntitiy.StreamMediaList>();
